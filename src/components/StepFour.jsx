    ...
    useEffect(()=>{
        if(source?.length && destination.length){
            ...
            const distanceInKM=getDistance(
                parseFloat(sourceVal[0]), parseFloat(sourceVal[1]), parseFloat(destinationVal[0]), parseFloat(destinationVal[1])
            );
            ...
            <div className="grid grid-cols-1 p-4 mt-10">
                ...
                <div className="pt-8">
                    <div className="flex justify-between items-center border-b mb-5 pb-5">
                        ...
                        <p className="text-lg font-bold">Price : <span className="text-2xl">Rs {price}</span></p>
                    </div>
